...
| File | Topic |
|------|-------|
| 1_Basic Navigation and File Management | Terminal navigation, file operations |
| 2_Working with Hidden Files, Permissions | Hidden files, file info |
| 3_Move files between directories | File management |
| 4_File Permissions and Ownership | chmod, chown |
